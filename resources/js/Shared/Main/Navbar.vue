        ...
        <Container class="md:block hidden relative">
            <div class="flex items-center">
                <ul class="flex flex-row list-none">
                    ...
                    <li>
                        <a ref="nofollow" href="https://tyresanywhere.com/search-tyres" class="border-l nav-link-gradient-animation nav-link-gradient-1 lg:text-sm text-[13px] text-gray-100 hover:text-wheelfit-600 border-gray-800 lg:py-3 lg:px-5 py-2 lg:px-4 px-3 block transition duration-150 ease-in-out" title="Search Tyres">Search Tyres</a>
                    </li>
                    <li>
                            ...
                            <template v-slot:content>
                                <div class="flex flex-row m-0">
                                    ...
                                    <div class="lg:w-1/4 w-1/3 px-3">
                                        ...
                                        <hr class="my-2 border-t-2 border-wheelfit-300/30">
                                        <div class="space-y-2">
                                            <a class="block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200" ref="nofollow" href="https://tyresanywhere.com/search-tyres" title="Search Tyres">Search Tyres</a>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="https://tyresanywhere.com/cart" rel="nofollow" class="border-x lg:text-sm text-[13px] text-gray-100 hover:text-wheelfit-600 border-gray-800 lg:py-3 lg:px-5 py-2 lg:px-4 px-3 block transition duration-150 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div v-show="mobileNavShow" class="md:hidden block mobile-nav w-72 fixed top-0 left-0 z-50">
                <div class="h-screen overflow-y-scroll">
                    ...
                    <div class="flex flex-col">
                        ...
                        <a href="https://tyresanywhere.com/search-tyres" rel="nofollow" title="Search Tyres" class="border-b w-full py-4 pl-4 border-[#ebebeb] text-sm text-gray-400">Search Tyres</a>
                        ...
                        <a href="https://tyresanywhere.com" rel="nofollow" class="w-full py-4 pl-4 border-[#ebebeb] text-sm text-gray-400 border-b flex justify-start items-center">
                            Your Cart
